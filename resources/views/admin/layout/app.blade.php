                ...
                <div class="menu-sidebar__content js-scrollbar1">
                    <nav class="navbar-sidebar">
                        <ul class="list-unstyled navbar__list">
                            ...
                            <li>
                                <a href="{{route('piza#list')}}">
                                 <i class="fa-solid fa-pizza-slice"></i>Products</a>
                            </li>

                             <li>
                                <a href="{{route('adminOrder#list')}}">
                                 <i class="fa-solid fa-file-waveform"></i> OrderList </a>
                             </li>
                             <li>
                                <a href=" {{route('user#list')}}">
                                    <i class="fa-solid fa-users"></i>Userlist
                                </a>
                             </li>
                             <li>
                                <a href="{{route('user#message')}}">
                                    <i class="fa-solid fa-users"></i>User Response Message
                                </a>
                             </li>
                        </ul>
                    </nav>

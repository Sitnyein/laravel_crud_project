            ...
            <div class="col-md-12">
                ...
                <div class="table-data__tool">
                    <div class="table-data__tool-left">
                        <div class="overview-wrap">
                            <h2 class="title-1">Categroy List</h2>
                ...
                <div class="row mt-2">
                    <div class="col-2 offset-10 btn bg-white shadow-sm py-1 px-1 text-center ">
                         <i class="fa-solid fa-database me-2"></i> {{ $categories->total() }}
                    </div>
                </div>
                       ...
                       <tr class="tr-shadow">
                        ...
                        <td>
                            ...
                            <a href="{{route('category#edit',$category->id)}}">
                             ...
                             <a href="{{route('categroy#delete',$category->id)}}">
...
{{-- <form action="{{route('logout')}}" method="post">
    @csrf
 <input type="submit" class="btn btn-danger text-dark" value="logoutPage">
</form> --}}
@endsection

               ...
               <div class="product-item bg-light">
                <div class="product-img position-relative overflow-hidden" >
                    ...
                    <div class="product-action">
                        {{-- <a class="btn btn-outline-dark btn-square" href="{{route('add#cart')}}"><i class="fa fa-shopping-cart"></i></a> --}}
                        <a class="btn btn-outline-dark btn-square" href="{{route('pizza#deatails',$pl->id)}}"><i class="fa-solid fa-circle-info"></i></a>
                ...
                <div class="text-center py-4">
                    ...
                    <div class="d-flex align-items-center justify-content-center mt-2">
                        <h5>{{$pl->price}} kyats</h5><h6 class="text-muted ml-2"></h6>
                    </div>
